		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<! <img src="kepsek/logo4.png" alt="navbar brand" class="navbar-brand" width="40"> 
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMKN 4 BANDAR LAMPUNG (<a href="index.php">rpl1 </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
