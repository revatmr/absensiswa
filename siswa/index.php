...
<head>
	...
	<link rel="icon" href="../assets/img/user/logo4.png" type="image/x-icon"/>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<img src="../assets/img/user/logo4.png" alt="navbar brand" class="navbar-brand" width="40"> 
					<b class="text-white">SMKN 4 BDL</b>
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<!-- foto profil -->
									<img src="https://i.pinimg.com/564x/b8/5f/3a/b85f3a28fd572685b0dab45537113294.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="https://i.pinimg.com/564x/b8/5f/3a/b85f3a28fd572685b0dab45537113294.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4><?=$data['nama_siswa'] ?></h4>
												<p class="text-muted"><?=$data['nip'] ?></p>
												<a href="?page=jadwal" class="btn btn-xs btn-secondary btn-sm">Jadwal Belajar</a> 
											</div>
										</div>
									</li>
									<li>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMKN4 (<a href="index.php">11 rpl 1 </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
