					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?=$data['nama_siswa']; ?></b></b></h5>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="../assets/img/nadyapp.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">nadya cantik</div>
												<div class="status">rpl 1</div>
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../assets/img/parlinpp.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">parlindungan</div>
												<div class="status">rpl 1</div>
											</div>
											<button class="btn btn-icon btn-primary btn-round btn-xs">
												<i class="fa fa-plus"></i>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../assets/img/azfarpp.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
												<div class="username">azfar</div>
												<div class="status">rpl 1</div>
											</div>
											<button class="btn btn-icon btn-primary btn-round btn-xs">
												<i class="fa fa-plus"></i>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="../assets/img/dhanipp.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
